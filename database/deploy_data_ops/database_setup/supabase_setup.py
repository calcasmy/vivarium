# vivarium/database/deploy_data_ops/database_setup/supabase_setup.py
"""
...
class SupabaseSetup(DBSetupStrategy):
    ...
    def _build_psql_connection_command(self, sql_script_path: str) -> list[str]:
        """
    ...
    def execute_full_setup(self, sql_script_name: str) -> Tuple[bool, Optional[DBOperations]]:
        ...
        try:
            ...
            psql_command = self._build_psql_connection_command(sql_script_path)
            ...
            if success:
                ...
                self.db_ops.connect(self.connection_details)
