...
from utilities.src.database_operations import ConnectionDetails
...
class DatabaseConfig(Config):
    ...
    def __init__(self):
        ...
        self._remote_host           = self.get(db_section, 'remote_host', default='192.168.68.72')
    ...
    def postgres_superuser_connection(self) -> ConnectionDetails:
        ...
        return ConnectionDetails(
            ...
            host                    = self._local_host, # Superuser often connects locally initially
            port                    = self._local_port
        )
...
class FileConfig(Config):
    ...
    def __init__(self):
        """
        Initializes the FileConfig, loading file path settings.
        """
        super().__init__()
