...
#     def execute_query(self, query: str, params: Optional[tuple] = None, fetch: bool = False) -> Optional[List[Dict] | None]:
...
#             logger.error(f"An unexpected error occurred: {e} | Query: {query} | Params: {params}")
#             self.conn.rollback()
#             return None
